...
namespace Library.DataAccess
{
    public class LibraryContext : DbContext
    {
        ...
        public LibraryContext()
        {
            ...
            string connectionString = "Server=tcp:bo19.database.windows.net,1433;Initial Catalog=BachDB;Persist Security Info=False;User ID=bo19;Password=¤\"%Vvnmi03104g9h12fv345;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
